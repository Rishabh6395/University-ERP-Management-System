...
int main(){
	...
	t.root = t.insertion_Faculty(t.root, 1001, "aman", "osman", "17300", "Male", "0300-0000001", "HOD", "aman12@gmail.co", "PHD", 50, "Punjab","PWR","Active");
	t.root = t.insertion_Faculty(t.root, 1002, "Rahul", "NIL", "17301", "Male", "0301-5267432", "Assitant Professor", "rahul12@gmail.com", "POST_DOC",48, "hyatabad","PWR", "Active");
	...
	// for admin staff
	a.root6 = a.insertion_Faculty(a.root6,7001,"rishabh","bhatt","17301","male","6395646026","Manager","rishabhbhatt956@gmail.com","CS",21,"LHR","pwr","Active");
	// for board of governers
	w.insertion_List1(11, "Dr. Rahul", "17302", "male", "Rector-Chairman", "Ayub@nu.edu.co");
	w.insertion_List1(10, "Mr. Naman", "35707", "male", "Members","ahmad@nu.edu.co");
